...
public final class PlantAttackEffectCatalog {
    ...
    static {
        ...
        register(PlantType.CAULIPOWER, "768/INITIAL/EFFECTS/CAULIPOWER_PROJECTILE/CAULIPOWER_PROJECTILE.PAM", "animation", 0.6f);
        register(PlantType.ELECTRIC_BLUEBERRY, "768/INITIAL/EFFECTS/ELECTRICBLUEBERRY_CLOUD_PROJECTILE/ELECTRICBLUEBERRY_CLOUD_PROJECTILE.PAM", "attack", 0.6f);
        register(PlantType.STARFRUIT, "768/INITIAL/EFFECTS/STARFRUIT_PROJECTILE_PLANTFOOD/STARFRUIT_PROJECTILE_PLANTFOOD.PAM", "animation", 0.5f);
        register(PlantType.GRAPESHOT, "768/INITIAL/EFFECTS/ESCAPEROOT_EXPLOSION_GRAPESHOT_PROJECTILE/ESCAPEROOT_EXPLOSION_GRAPESHOT_PROJECTILE.PAM", "attack", 0.6f);
        register(PlantType.KIWIBEAST, "768/INITIAL/EFFECTS/KIWIBEAST_TILE_HIT/KIWIBEAST_TILE_HIT.PAM", "animation", 0.5f);
        register(PlantType.GOO_PEASHOOTER, "768/INITIAL/EFFECTS/GOOPEASHOOTER_PROJECTILES/GOOPEASHOOTER_PROJECTILES.PAM", "projectile_t1", 0.5f);
        register(PlantType.CABBAGE_PULT, "768/INITIAL/EFFECTS/CABBAGEPULT_PLANTFOOD_PROJECTILE/CABBAGEPULT_PLANTFOOD_PROJECTILE.PAM", "animation", 0.6f);
        register(PlantType.CACTUS, "768/INITIAL/EFFECTS/T_CACTUS_PROJECTILE/T_CACTUS_PROJECTILE.PAM", "idle", 0.6f); // confirmed: [idle, idle2, idle3]
