...
public final class PlantAttackEffectCatalog {
    ...
    static {
        ...
        register(PlantType.ELECTRIC_BLUEBERRY, "768/INITIAL/EFFECTS/ELECTRICBLUEBERRY_CLOUD_PROJECTILE/ELECTRICBLUEBERRY_CLOUD_PROJECTILE.PAM", "animation", 0.6f);
        register(PlantType.FIRE_PEASHOOTER, "768/INITIAL/EFFECTS/FIREPEASHOOTER_FIRE/FIREPEASHOOTER_FIRE.PAM", "animation", 0.5f);
        register(PlantType.GOO_PEASHOOTER, "768/INITIAL/EFFECTS/GOOPEASHOOTER_PROJECTILES/GOOPEASHOOTER_PROJECTILES.PAM", "projectile_t1", 0.5f); // confirmed: [projectile_t1/2/3, hit_t1/2/3]
        register(PlantType.GRAPESHOT, "768/INITIAL/EFFECTS/GRAPESHOT_PROJECTILE/GRAPESHOT_PROJECTILE.PAM", "animation", 0.6f);
