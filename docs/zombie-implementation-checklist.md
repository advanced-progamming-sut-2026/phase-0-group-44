...
Canonical runtime data is loaded from `phase1/assets/Data/zombies.csv`. The separate `bonus-zombies.txt` file preserves the cyan/blue row classification transcribed from the supplied PDF. Factory registration intentionally covers only mandatory rows.

## Coverage summary

- 28 classified document/repository rows
- 22 mandatory rows implemented
- 6 blue/bonus rows excluded
...
| 9 | `ARCADE_ZOMBIE` / Arcade Zombie | BONUS — skipped | COMMON | 490 | 0.190 | 100 | 600 | arcadeMachine:1100:false | Pushes arcade machine and kills on collision (bonus, skipped). | BONUS — no factory registration | ZombieRegistryTest bonus exclusion |
...
| 21 | `TROGLOBITE` / Troglobite | BONUS — skipped | FROSTBITE_CAVES | 470 | 0.185 | 100 | 600 | groundIce:1100:false | Pushes ground ice (bonus, skipped). | BONUS — no factory registration | ZombieRegistryTest bonus exclusion |
| 22 | `FISHERMAN` / Fisherman | BONUS — skipped | BIG_WAVE_BEACH | 1000 | 0.185 | 100 | 700 | — | Hooks plants from right edge (bonus, skipped). | BONUS — no factory registration | ZombieRegistryTest bonus exclusion |
...
| 25 | `JESTER` / Jester / Juggler | BONUS — skipped | DARK_AGES | 420 | 0.200 | 100 | 450 | — | Reflects direct shots while spinning (bonus, skipped). | BONUS — no factory registration | ZombieRegistryTest bonus exclusion |
| 26 | `WIZARD` / Wizard | BONUS — skipped | DARK_AGES | 490 | 0.120 | 100 | 800 | — | Transforms plants until Wizard death (bonus, skipped). | BONUS — no factory registration | ZombieRegistryTest bonus exclusion |
| 27 | `KING` / King | BONUS — skipped | DARK_AGES | 1000 | 0.185 | 100 | 750 | — | Upgrades simple zombies to Knights (bonus, skipped). | BONUS — no factory registration | ZombieRegistryTest bonus exclusion |
...
- `ZombieSpecialSystem` mirrors mandatory state transitions in the command-driven ten-ticks-per-second simulation.
- `zombies info` reports type, decimal position, base health, each intact armor part, and timed effects.
- `cheat spawn-zombie -t <zombie-type> -l <x, y>` rejects unknown, bonus, invalid-tile, and wrong-chapter spawns.
...
- Bonus rows remain in canonical data for classification and display, but have no mandatory factory strategy and cannot be spawned or selected in Phase 1.
